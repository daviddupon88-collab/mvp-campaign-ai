...
- **Hypothèses infrastructure/support non vérifiées** (item 76) — aucune ligne de coût infra/support n'existe dans ce dépôt ; les montants utilisés pour la formule marge nette sont des hypothèses de travail (détaillées dans l'artifact d'audit), à remplacer par les chiffres réels dès qu'ils sont disponibles.
