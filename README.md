...
62. ~~Pas de contrôle de longueur en temps réel côté Content Studio~~ ✅ fait — `google-ads-body-guard.ts`, appliqué dans `editContent()` pour les contenus du canal `googleads` uniquement ; un format de texte non reconnu (réécriture libre) n'est jamais bloqué.
